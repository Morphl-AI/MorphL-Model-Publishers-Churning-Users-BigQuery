...
class ScalerTransformer:
    ...
    def get_transformed_numeric_data(self):
        ...
        for column in self.num_labels:
            ...
            pkl_file = f'{self.models_dir}/{self.model_day_as_str}_{self.unique_hash}_ga_chp_bq_box_cox_{column}.pkl'
        ...
        pkl_file = f'{self.models_dir}/{self.model_day_as_str}_{self.unique_hash}_ga_chp_bq_pipeline.pkl'
